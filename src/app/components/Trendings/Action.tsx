...
const Action = () => {
  ...
  const { data, isLoading } = useQuery(["actionMovieData"], async () => {
    const { data } = await axios.get(
      "https://api.themoviedb.org/3/discover/movie?page=1&sort_by=popularity.desc&with_genres=28",
      options
    );
    return data as ActionMovie;
  });
