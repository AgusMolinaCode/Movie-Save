...
const Horror = () => {
  ...
  const { data, isLoading } = useQuery(["horrorMovieData"], async () => {
    const { data } = await axios.get(
      "https://api.themoviedb.org/3/discover/movie?sort_by=popularity.desc&with_genres=27",
      options
    );
    return data as HorrorMovie;
  });
